...
-Skills: SQL • Security Analysis • Log Investigation • Incident Investigation

-Used SQL queries to investigate security-related data and identify activity relevant to a security investigation.
